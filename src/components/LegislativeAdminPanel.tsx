...
export default function LegislativeAdminPanel({ session }: { session: AuthSession }) {
  ...
  return <section>
    <div className="flex flex-wrap items-end justify-between gap-4 border-b-2 border-navy pb-5">
      <div><p className="section-kicker">LEGISLATIVE MONITOR</p><h2 className="editorial-title mt-2 text-3xl font-bold text-navy">입법감시 관리</h2><p className="mt-2 text-sm leading-6 text-charcoal/55">자동 수집한 법안을 검토하고, 공개 승인과 씨앗의 편집 판단을 관리합니다. 자동 게시와 알림 발송은 하지 않습니다.</p></div>
