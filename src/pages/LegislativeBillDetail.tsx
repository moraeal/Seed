  ...
  return <article className="bg-paper pb-16">
    ...
    <div className="article-content-frame py-9 sm:py-12">
      ...
      {bill.media_coverage?.length > 0 && <NumberedSection number="07" title={ko ? "이 법안을 설명하는 언론 보도" : "News coverage explaining this bill"}>
        <p className="mb-5 text-sm leading-7 text-charcoal/60">{ko ? "법안과 발의자를 대조해 같은 법안을 다룬 보도만 골랐습니다. 아래 내용은 기사 핵심을 자동으로 요약한 뒤 편집 승인을 거쳐 공개합니다." : "Coverage is matched against the bill and sponsor. These summaries are generated automatically and published only after editorial approval."}</p>
