...
export default function FoundingStatement() {
  ...
  const sections = ko
    ? [
        ...
        ["한 사람의 질문에서 시작했습니다", "나는 규모 있는 조직이나 언론사를 배경으로 갖고 있지 않습니다. 씨앗의 소리는 한 사람의 질문과 판단에서 시작했습니다. 출발이 작다는 사실을 감추지 않되 한 사람에게 머무는 미디어로 규정하지 않겠습니다. 질문에 공감하는 시민들이 각자의 경험과 목소리를 더하며 함께 성장하는 독립 시민저널을 만들겠습니다."],
    ...
    : [
        ...
        ["It began with one person’s questions", "I do not have a large organization or media company behind me. SEED VOICE began with one person’s questions and judgment. I will not hide its small beginning, but neither will I define it as a publication meant to remain with one person. It will grow as citizens who share these questions add their own experience and voices."],
    ...
    <article className="bg-paper pb-16 sm:pb-20">
      ...
      <div className="container-page max-w-4xl py-10 sm:py-12">
        ...
        <footer className="mt-11 border-t-2 border-navy pt-7">
          <p className="text-sm font-extrabold tracking-[.06em] text-green-deep">{ko ? "2026년 9월 · 어느 작은 시민의 말, 씨앗의 소리 발행인" : "September 2026 · Words of an Ordinary Citizen, Publisher of SEED VOICE"}</p>
