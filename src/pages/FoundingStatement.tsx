...
export default function FoundingStatement() {
  ...
  const sections = ko
    ? [
        ...
        ["자유로운 시민과 강한 사회가 필요합니다", "우리는 자유, 법치, 시장의 자율과 시민의 책임을 소중히 여깁니다. 유능한 국가는 필요하지만 국가의 힘에는 헌법과 법률의 한계가 있어야 합니다. 역동적인 시장도 필요하지만 공정한 규칙과 사회적 신뢰 위에서 작동해야 합니다. 국가와 시장이 사람을 위해 존재하도록 붙잡아주는 공공성의 자리가 바로 시민사회이며, 강한 시민사회는 자유로운 시민이 스스로 판단하고 협력할 때 만들어집니다."],
    ...
    : [
        ...
        ["A Free Citizenry and a Strong Society", "We value freedom, the rule of law, open markets, and civic responsibility. A capable state is necessary, but its power must remain limited by constitutional law. Dynamic markets are necessary, but they depend on fair rules and social trust. Civil society is the public space that keeps state and market accountable to human life, and it grows strong when free citizens judge and cooperate for themselves."],
