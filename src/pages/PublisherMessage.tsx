...
const copy = {
  ko: {
    ...
    creed: [
      { title: "사실을 먼저 확인합니다", description: "원문과 공개자료를 대조하고 사실과 의견을 구분합니다." },
      ...
      { title: "오류를 바로잡습니다", description: "잘못된 사실과 판단이 확인되면 공개적으로 수정합니다." },
    ] satisfies CreedItem[],
  ...
  en: {
    ...
    creed: [
      { title: "Facts come first", description: "We compare primary sources and public records, separating fact from opinion." },
      ...
      { title: "Errors are corrected", description: "When facts or judgments prove wrong, the record is corrected openly." },
    ] satisfies CreedItem[],
