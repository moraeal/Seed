...
const copy = {
  ko: {
    ...
    aiTitle: "사람과 AI가 함께 만들지만, 판단과 책임은 사람이 집니다",
    ai: "씨앗의 소리는 시민의 질문과 판단에 AI의 도움을 더해 만드는 독립 시민미디어입니다. AI는 자료 탐색, 구조화, 교차검토와 제작을 돕지만 질문을 선택하고 관점을 세우며 최종 결과에 책임지는 주체는 저자와 편집인입니다. 오류가 발견되면 근거를 다시 확인하고 투명하게 고치겠습니다.",
  ...
  en: {
    ...
    aiTitle: "People work with AI; human judgment remains accountable",
    ai: "SEED VOICE is an independent civic publication that brings AI assistance to citizens’ questions and judgment. AI assists with research, structure, cross-checking and production. Authors and editors choose the questions, form the viewpoint and remain responsible for every result. When errors are found, we will recheck the evidence and correct them transparently.",
