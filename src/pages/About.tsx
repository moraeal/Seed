    ...
    <div className="bg-paper">
      <header className="border-b border-green-deep/15 bg-ivory py-14 sm:py-20">
        <div className="container-page grid gap-10 lg:grid-cols-[1.2fr_.8fr] lg:items-end">
          <div><p className="section-kicker">ABOUT SEED CIVIC JOURNAL</p><h1 className="editorial-title mt-5 max-w-4xl text-4xl font-bold leading-[1.08] text-navy sm:text-6xl">{ko ? "시민이 스스로 판단할 수 있도록 사실과 맥락, 관점을 전합니다." : "Facts, context, and viewpoint for citizens who judge for themselves."}</h1></div>
          <p className="border-l-2 border-gold pl-6 text-base leading-8 text-charcoal/68 sm:text-lg">{ko ? "씨드 시민저널은 국가와 시장, 시민사회의 중요한 변화를 시민의 언어로 기록하고 해석하는 독립 저널입니다. 진영의 구호를 대신 반복하지 않고, 확인된 사실에서 출발해 자유와 책임의 관점으로 공공의 문제를 살핍니다." : "SEED Civic Journal is an independent publication explaining changes in the state, market, and civil society. We begin with verified facts and examine public affairs through freedom and responsibility."}</p>
        </div>
      </header>
      ...
      <section className="py-14 sm:py-20">
        <div className="container-page grid gap-10 lg:grid-cols-[.72fr_1.28fr] lg:gap-16">
          ...
          <div className="space-y-5 text-base leading-8 text-charcoal/68">
            ...
            <p className="font-semibold text-navy">{ko ? "씨드 시민저널은 시민을 정치의 관객이나 정보의 소비자로 보지 않습니다. 시민이 사건의 맥락을 이해하고 권력을 질문하며 자신의 판단을 세울 수 있도록 돕는 것이 저널의 역할이라고 믿습니다." : "We do not see citizens as political spectators or passive consumers of information. A civic journal should help them understand context, question power, and reach their own judgments."}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 sm:py-20">
        <div className="container-page max-w-5xl">
          <div className="border-t-2 border-navy bg-white py-8 sm:px-8">
            ...
            <p className="mt-5 max-w-4xl text-base leading-8 text-charcoal/66">{ko ? "씨드 시민저널은 어떤 정당의 선거조직이나 정부사업의 동원 수단이 되지 않습니다. 누가 집권하든 같은 원칙으로 권력을 살피고, 공익을 말하는 조직과 주장도 시민 앞에 근거를 제시해야 한다고 믿습니다. 발행 주체는 씨드시민파트너스이며, 창립 때 세운 시민사회의 문제의식과 원칙은 창립취지문에 그대로 담겨 있습니다." : "SEED Civic Journal is not an electoral arm of any party or a vehicle for government mobilization. Its publisher is SEED Civic Partners, and its founding principles remain set out in the Founding Statement."}</p>
