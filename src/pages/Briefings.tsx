...
export default function Briefings() {
  ...
  return <section className="section-band bg-paper">
    <div className="container-page">
      ...
      >
        <div className="max-w-[64%] sm:max-w-[58%]"><span className="text-xs font-extrabold tracking-[0.18em] text-gold-light">SEED CITIZEN BRIEFING</span><h1 className="mt-4 text-4xl font-extrabold sm:text-5xl lg:text-6xl">시민브리핑</h1><p className="mt-5 max-w-lg text-sm leading-7 text-white/85 sm:text-base">가짜뉴스와 왜곡된 정보가 넘치는 시대, 확인된 사실과 맥락으로 시민의 정확한 이해를 돕습니다.</p></div>
