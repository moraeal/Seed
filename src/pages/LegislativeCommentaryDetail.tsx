...
export default function LegislativeCommentaryDetail() {
  ...
  return <article className="bg-paper pb-12 sm:pb-16">
    ...
    <div className="article-content-frame py-8 sm:py-12">
      <InteractiveFigure src={imageSrc(article.heroSrc)} alt={edition.heroAlt} caption={edition.heroCaption} credit={ko ? "AI 합성 이미지" : "AI-generated composite image"} figureClassName="overflow-hidden border border-green-deep/10 bg-white shadow-[0_22px_65px_rgba(23,76,58,.1)]" imageClassName="aspect-[16/9] w-full object-cover" />
