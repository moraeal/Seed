  ...
  return <article className="bg-paper pb-12 sm:pb-16">
    <header className="border-b border-green-deep/15 bg-ivory py-5 sm:py-7">
      <div className="container-page max-w-5xl">
        ...
        <div className="pt-4 text-center"><span className="section-kicker">LEGISLATIVE COMMENTARY</span><h1 className="article-detail-title mt-2">{edition.title}</h1><p className="article-detail-subtitle">{edition.subtitle}</p><p className="article-summary">{edition.summary}</p></div>
