...
import { ContentViewStat, EngagementSummary, getEngagementData, NewsletterSubscriber } from "../lib/engagement";
    ...
    <section className="min-h-[70vh] bg-ivory py-12 sm:py-16">
      <div className="container-page">
        ...
        <div className="mt-7 grid gap-4 sm:grid-cols-3">
          ...
          <article className="border border-green-deep/15 bg-white p-5"><BarChart3 className="text-green-mid" size={20}/><p className="mt-4 text-xs font-bold text-charcoal/45">{ko ? "최근 7일 조회" : "Views · 7 days"}</p><p className="editorial-title mt-1 text-3xl font-bold text-navy">{(totals.page_views_7d || 0).toLocaleString()}</p></article>
