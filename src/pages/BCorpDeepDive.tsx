    ...
    <article className="bg-paper">
      ...
      <div className="article-content-frame py-9 sm:py-12">
        <figure className="mb-8 overflow-hidden rounded-xl border border-green-deep/10 bg-white shadow-[0_18px_55px_rgba(23,76,58,.08)]">
          ...
          <figcaption className="border-t border-green-deep/10 px-4 py-3 text-xs leading-5 text-charcoal/55">기업의 행동과 성과를 투명하게 공개하고 시민·소비자·투자자가 선택하는 시장을 상징적으로 표현했습니다. · AI 이미지</figcaption>
        </figure>
