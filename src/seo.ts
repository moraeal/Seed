...
const staticRoutes: SeoRoute[] = [
  ...
  { path: "/about", title: "내 삶에 닿는 뉴스, 씨앗과 함께 읽어요 | 씨앗의 소리", description: "내 세금은 어디에 쓰였을까? 동네 의료에는 어떤 변화가 생길까? 씨앗의 소리는 뉴스 속 숫자와 제도를 쉬운 말로 풀고, 시민의 일상과 이어서 설명합니다.", type: "website", lastModified: latestDate, image: assetUrl("images/about-citizens.webp"), imageAlt: "햇살이 드는 동네에서 밝게 이야기를 나누는 시민들" },
