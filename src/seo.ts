...
const staticRoutes: SeoRoute[] = [
  ...
  { path: "/publisher-message", title: "발행인 인사말 | 씨앗의 소리", description: "한 사람의 질문과 판단에서 시작된 독립 시민미디어 씨앗의 소리의 발행인 인사말입니다.", type: "article", lastModified: latestDate, author: "서한결", section: "발행인 인사말" },
