...
const staticRoutes: SeoRoute[] = [
  ...
  { path: "/seed-language/why-civic-language", title: "우리가 다시 뜻을 새겨야 할 말들 | 씨앗의 소리", description: "말이 현실을 어떻게 나누고 무엇을 감추는지 살피며, 자유·권력의 제한·책임·시민의 성장이라는 기준으로 씨앗이 정리할 시민언어 전체 지도입니다.", type: "article", publishedAt: "2026-09-22", lastModified: "2026-09-22", author: "작은씨앗", section: "시민언어" },
