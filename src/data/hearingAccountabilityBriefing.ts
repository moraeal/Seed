...
export const hearingAccountabilityBriefing: Briefing = {
  ...
  sourceNote: "이 글은 2026년 9월 13일, 김승원 법무부 장관 후보자 인사청문회 개최 전 공개자료를 기준으로 작성했습니다. ‘24건 중 19건’은 특정 시민단체의 통계를 인용한 수치가 아닙니다. 씨앗의 소리가 2025년 6월 25일부터 2026년 6월 26일까지 실제로 열린 국무총리·국무위원 후보자 청문회 24건을 확정한 뒤, 국회 회의 진행 기록과 인사청문회 실시계획 의결 기록, 국회 의안정보시스템의 인사청문요청안 정보, 국회방송 전체회의 영상을 후보자별로 대조해 다시 계산했습니다. 증인 ‘최종 채택’ 인원이 0명인지를 기준으로 판정했고 참고인은 별도로 확인했습니다. 유임으로 청문회를 거치지 않은 인사와 청문회 전에 사퇴한 후보자는 분모에서 제외했습니다. 건별 출처·판정 근거와 계산식은 내부 검증표로 보존했습니다. 9월 15~16일 예정된 다른 장관 후보자 청문회 결과에 따라 전체 건수와 비율은 다시 확인해야 합니다.",
  sources: [
