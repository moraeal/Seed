...
export const hearingAccountabilityBriefing: Briefing = {
  ...
  summary: "청문회는 대통령의 선택을 승인하는 행사가 아니라 시민이 권력을 검증하는 절차입니다. 참여연대가 2026년 6월까지 집계한 총리·국무위원 후보자 청문회 24건 가운데 19건에는 증인이 없었습니다.",
  introTitle: "1. 증인이 없으면 후보자의 말만 듣게 됩니다",
  keyHighlights: [
    "참여연대 집계에 따르면 이재명 정부에서 2026년 6월까지 열린 국무총리·국무위원 후보자 인사청문회 24건 가운데 19건이 증인 없이 진행됐습니다. 79.2%, 약 80%입니다.",
  ...
  images: [
    ...
    },
    {
      ...
      caption: "참여연대가 2026년 6월까지 진행된 국무총리·국무위원 후보자 청문회를 집계한 결과입니다. 다른 기준의 언론 집계도 있어 기준 시점과 대상을 함께 표시했습니다.",
      credit: "씨앗의 소리 인포그래픽 · 참여연대 집계",
      sourceUrl: "https://peoplepower21.org/government/2025169",
      afterSection: 1,
      contain: true,
    },
  ],
  ...
  sections: [
    {
      ...
      paragraphs: [
        "김승원 후보자만의 문제가 아닙니다.",
        "참여연대가 2026년 6월까지 진행된 국무총리·국무위원 후보자 인사청문회를 집계한 결과, 24건 가운데 19건이 증인 없이 진행됐습니다. 비율로는 79.2%, 약 80%입니다.",
  ...
  sourceNote: "이 글은 2026년 9월 13일, 김승원 법무부 장관 후보자 인사청문회 개최 전 공개자료를 기준으로 작성했습니다. ‘24건 중 19건’은 참여연대가 2026년 6월까지 진행된 국무총리·국무위원 후보자 청문회를 집계한 수치입니다. 일부 언론은 다른 수치를 보도했으나 집계 대상과 산정 방식이 공개되지 않아 본문에는 출처와 기준 시점을 명시한 참여연대 집계를 사용했습니다. 9월 15~16일 예정된 다른 장관 후보자 청문회 결과에 따라 전체 건수와 비율은 다시 확인해야 합니다.",
  sources: [
    { label: "참여연대 — 이재명 정부 청문회 24건 중 19건이 증인 없이 진행", url: "https://peoplepower21.org/government/2025169" },
