...
export const newsArticles: NewsArticle[] = [
{
  ...
  "date": "2026-09-03",
  "readMinutes": 8,
  "title": "2030년 1,000조 원 나라살림—성장투자인가, 낙관적 세수 전망인가",
  ...
  "heroImage": {
    ...
    "caption": "정부 재정은 규모뿐 아니라 세입 전망의 지속 가능성과 사업의 우선순위까지 함께 검증해야 합니다. 실제 예산 심사 현장이 아닌 설명용 이미지입니다.",
    "credit": "자료이미지 · 씨드시민파트너스 AI 제작"
  },
  "inlineImage": {
    "src": "/images/briefings/briefing-05-budget-oversight.webp",
    "alt": "시민과 독립적인 검증자들이 지출과 미래투자, 국채 관련 예산서류를 구분해 점검하는 상징 이미지",
    "caption": "중기 재정계획에는 낙관적 전망뿐 아니라 세수가 예상보다 적을 때의 조정 순서와 책임도 포함되어야 합니다. 실제 현장이 아닌 설명용 이미지입니다.",
    "credit": "자료이미지 · 씨드시민파트너스 AI 제작"
  },
  "sections": [
    {
