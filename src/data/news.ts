...
{
  "slug": "president-civic-society-dialogue-representation",
  "issue": 9,
  "category": "시민사회·공론장",
  "date": "2026-09-06",
  "readMinutes": 7,
  "title": "대통령과 시민사회의 210분, 누가 ‘시민’을 대표했나",
  "subtitle": "19개 시민사회단체가 국정 참여 확대를 제안했습니다. 대화의 필요성과 별개로, 정부가 듣는 시민의 범위와 권력화된 시민사회를 감시할 장치도 함께 물어야 합니다.",
  "summary": "이재명 대통령은 9월 4일 청와대에서 시민사회 관계자들과 3시간 30분 동안 간담회를 열고 국가시민참여위원회, 주거복지, 통합돌봄, 일자리 등의 제안을 들었습니다. 시민사회의 국정 참여는 민주주의를 보완할 수 있지만, 참여 단체의 대표성·선정 기준·재정 독립성과 정책 반영 과정이 공개되지 않으면 조직된 일부가 ‘시민 전체’의 이름으로 영향력을 독점할 위험도 있습니다.",
  "keySentence": "정부가 시민의 목소리를 듣는 것과 정부가 들을 시민을 선택하는 것은 전혀 다른 일입니다.",
  "selectedNews": {
    "outlet": "연합뉴스",
    "publishedAt": "2026.09.04 10:41",
    ...
    "summary": [
      ...
      "대통령은 참석자들이 지향하는 세상과 자신이 만들고 싶은 세상의 차이가 크지 않다고 말했습니다."
    ]
  },
  "heroImage": {
    "src": "/images/columns/civic-society-selected-listening.webp",
    "alt": "정부와 시민사회 대표가 회의하고 유리벽 밖의 시민들이 지켜보는 상징 이미지",
    "caption": "시민사회와 정부의 대화는 필요합니다. 동시에 회의장 안의 대표가 누구이며 바깥의 시민에게 어떻게 책임지는지도 물어야 합니다. 실제 간담회 현장이 아닌 설명용 이미지입니다.",
  ...
  "sources": [
    { "label": "청와대 — 시민사회 초청 간담회 서면 브리핑", "url": "https://www.president.go.kr/briefings/Seib8dhP" },
    { "label": "연합뉴스 — 대통령 발언과 참석 단체 보도", "url": "https://www.yna.co.kr/view/AKR20260904062600001" },
    { "label": "서울경제 — 19개 시민사회단체 참석 및 간담회 내용", "url": "https://v.daum.net/v/20260904152451243" },
    { "label": "대한민국 정책브리핑 — 시민사회 초청 간담회 사진", "url": "https://www.korea.kr/multi/policyPhotoView.do?bbsKey=73223" }
  ]
},
{
  "slug": "prosecution-abolition-police-case-backlog",
  "issue": 8,
  "category": "사법·시민권리",
  "date": "2026-09-04",
  "readMinutes": 7,
  ...
  "video": {
    ...
    "title": "현장의 목소리｜김태규 의원이 대독한 일선 경찰관의 편지",
    "description": "준비 없는 수사권 전환과 인력·예산 부족을 호소하는 일선 경찰관의 편지를 김태규 의원이 대독한 영상입니다.",
    "disclaimer": "이 영상은 김태규 의원이 공개한 정치권 자료입니다. 씨드는 영상의 주장과 수치를 그대로 확정하지 않고, 공개 통계와 보도를 함께 확인했습니다."
  },
  "selectedNews": {
    "outlet": "한겨레",
    "publishedAt": "2026.09.04 05:01",
    ...
    "summary": [
      ...
      "경찰 수사 인력 보강이 진행 중이지만 기존 과부하와 대규모 사건 이관을 함께 감당하기에는 부족하다는 현장 우려가 제기됩니다."
    ]
  },
  "heroImage": {
  ...
  "sections": [
    ...
    { "title": "사건 하나마다 기다리는 시민이 있습니다", "paragraphs": [
    ...
    { "title": "개혁의 속도보다 중요한 국가의 책임", "paragraphs": [
    ...
    { "title": "정부와 국회가 답해야 할 질문", "bullets": [
  ...
  "sources": [
    { "label": "한겨레 — 검찰 미제 사건 최대 20만 건 전망과 경찰 업무 부담", "url": "https://www.hani.co.kr/arti/society/society_general/1276181.html" },
    { "label": "데일리안 — 2026년 6월 말 검찰 미제 사건 현황", "url": "https://www.dailian.co.kr/news/view/1674738" },
    { "label": "김태규 의원 — 일선 경찰관의 편지 대독 영상", "url": "https://www.youtube.com/watch?v=96gkBuAB_6k" }
  ]
},
{
  "slug": "2030-trillion-won-fiscal-plan-revenue-assumptions",
  "issue": 7,
  "category": "재정·국가책임",
  "date": "2026-09-03",
  "readMinutes": 8,
  "title": "1,000조 원 나라살림, 낙관적 세수의 덫",
  "subtitle": "지출 확대의 필요성만큼 중요한 것은 세입 전망이 빗나갔을 때의 조정 원칙입니다. 국회는 1,000조 원이라는 총액보다 전망의 근거와 사업별 퇴로를 먼저 검증해야 합니다.",
  "summary": "정부는 2027년 총지출을 820조9천억 원으로 늘리고, 2030년에는 1,005조2천억 원에 이르는 중기 재정계획을 제시했습니다. 정부는 세입과 경제성장이 뒷받침해 국가채무비율을 49% 안팎에서 관리할 수 있다고 전망하지만, 반도체 경기와 세수 증가가 계획대로 이어질지는 아직 확인되지 않았습니다.",
  "keySentence": "유능한 국가는 많이 쓰는 국가가 아니라, 세입 전망이 빗나가도 국민에게 책임질 수 있도록 우선순위와 퇴로를 함께 설계하는 국가입니다.",
  "selectedNews": {
    "outlet": "한국일보",
    "publishedAt": "2026.09.02 04:31",
    ...
    "summary": [
      ...
      "전문가들은 반도체 호황에 기대는 세입 전망과 경기 둔화 때 줄이기 어려운 반복 지출이 재정 운용의 위험이 될 수 있다고 지적했습니다."
    ]
  },
  "heroImage": {
  ...
  "sources": [
    { "label": "기획예산처 — 2027년 예산안 및 2026~2030년 국가재정운용계획", "url": "https://www.mpb.go.kr/web/main/bbs/b_0001/2629?baCommSelec=false&baNotice=false&baOpenDay=false&baUse=true&bcId=b_0001&cp=1&sortDirection=DESC&sortOrder=BA_REGDATE" },
    { "label": "대한민국 정책브리핑 — 2027년 예산안 공식자료", "url": "https://www.korea.kr/briefing/pressReleaseView.do?newsId=156776382&pWise=sub&pWiseSub=C3" },
    { "label": "한국개발연구원 경제정책정보 — 2027년 예산안 및 국가재정운용계획", "url": "https://eiec.kdi.re.kr/policy/materialView.do?num=286142" },
    { "label": "한국일보 — 2030년 총지출 1,000조 원 재정계획 분석", "url": "https://v.daum.net/v/20260902043138400" },
    { "label": "국가법령정보센터 — 국가재정법 제7조", "url": "https://www.law.go.kr/LSW//lsLawLinkInfo.do?chrClsCd=010202&lsId=010301&lsJoLnkSeq=900034363&print=print" }
  ]
},
{
...
},
{
  ...
  "date": "2026-09-01",
  "readMinutes": 8,
  "title": "GS리테일 166만 명 정보 유출…과징금 128억 원",
...
},
{
  ...
  "date": "2026-08-30",
  "readMinutes": 9,
  "title": "월 468만 원 소득에도 기초연금…공정성 논란",
...
},
  {
    ...
    date: "2026-08-29",
    readMinutes: 9,
    title: "청년 취업대책, 플랫폼보다 일자리",
    subtitle: "정부는 연결을 넓히겠다고 하지만, 청년들은 연결할 만한 좋은 일자리부터 늘려야 한다고 말합니다",
    summary: "한국일보는 정부의 청년 일자리 회복방안을 두고 취업준비생들이 기존 일경험 사업과 연결 플랫폼의 반복을 우려한다고 보도했습니다. 정부는 수요보다 사업 규모가 부족하고 2030년까지 30만 개 이상의 일자리를 추가로 만들겠다고 반박했습니다. 오늘의뉴스는 양쪽 주장을 나란히 놓고 정책의 성패를 가를 기준을 짚습니다.",
    ...
    selectedNews: {
      ...
      thumbnailCaption: "매일경제 보도가 다룬 청년 일자리 문제를 보여주는 오늘의뉴스 자료이미지",
      summary: [
        ...
        "오늘의뉴스는 참여 인원보다 프로그램이 실제 채용·근속·경력 형성으로 이어지는지를 성과 기준으로 확인해야 한다고 봅니다.",
      ],
    },
    heroImage: {
  ...
  },
  {
    ...
    date: "2026-08-28",
    readMinutes: 8,
    title: "한 총리, 신속 규제 즉시 해소",
    subtitle: "방향은 맞습니다. 그러나 무엇을 언제까지 어떻게 고칠지 시민이 확인할 수 있어야 합니다",
    summary: "한성숙 국무총리가 경제단체와 만나 빨리 해결할 수 있는 규제는 즉시 풀고, 이해관계가 복잡한 규제는 공론화를 거치겠다고 밝혔습니다. 오늘의뉴스는 이 발표가 왜 필요한지와 함께, 진짜 규제개혁이 되려면 무엇이 더 공개돼야 하는지 알기 쉽게 짚습니다.",
