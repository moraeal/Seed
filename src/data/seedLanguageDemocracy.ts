...
const democracyFeatureKo: SeedLanguageArticle = {
  ...
  date: "2026-09-09",
  readMinutes: 5,
  title: "민주는 왕을 뽑는 일이 아니라 권력을 제한하는 일이라는 말이다",
...
const democracyDeepKo: SeedLanguageArticle = {
  ...
  date: "2026-09-09",
  readMinutes: 15,
  title: "민주는 권력자의 깃발이 아니라 시민의 권리라는 말이다",
  ...
  sections: [
    ...
    },
    {
      "paragraphs": [
        ...
        "민주는 권력자의 깃발이 아니라 시민의 권리라는 말이다. 민주는 지도자를 향한 충성이 아니라 권력을 의심할 수 있는 자유다. 민주는 다수의 힘이 아니라 다수의 힘까지 제한하는 질서다.",
