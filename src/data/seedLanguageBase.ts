...
const citizenEn: SeedLanguageArticle = {
  ...
  heroImage: {
    ...citizenKo.heroImage,
    alt: "Citizens of different generations stepping forward as public agents amid an anonymous urban commute",
  ...
  inlineImage: {
    ...
    alt: "Citizens of different generations reviewing evidence and a neighborhood map to address a shared public problem",
