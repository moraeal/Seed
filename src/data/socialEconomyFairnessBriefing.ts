...
export const socialEconomyFairnessBriefing: Briefing = {
  ...
  summary: "사회연대경제를 돕는 취지는 좋습니다. 그러나 국가가 ‘좋은 기업’을 지정하고 금융·공공구매·위탁까지 우대하면 같은 시장의 일반기업과 소상공인은 어떤 영향을 받을까요. 씨앗의 질문은 하나입니다. 국가는 좋은 기업을 고르기보다 좋은 행동이 선택받는 시장을 만들어야 하지 않을까요.",
  date: "2026-09-11",
  author: "씨드 시민브리핑",
  readMinutes: 8,
  issueNumber: 9,
  ...
  content: [
    "사회적기업과 협동조합, 마을기업이 지역의 문제를 해결하고 취약계층의 일자리를 만드는 일은 가치가 있습니다. 시민들이 스스로 필요를 발견하고 돈과 시간, 책임을 나누는 활동은 건강한 시민사회의 중요한 자산입니다.",
    "그러나 사회적경제를 돕는 것과 국가가 ‘좋은 기업’을 직접 골라 키우는 것은 같은 일이 아닙니다. 국가가 특정 조직을 인증한 뒤 보조금과 정책금융, 공공구매, 수의계약, 공공서비스 위탁까지 하나의 지원체계로 연결하면 한쪽의 혜택은 같은 시장에서 경쟁하는 다른 기업의 상대적 불이익이 될 수 있습니다.",
    "그래서 이번 브리핑의 질문은 하나입니다. 사회적경제에 찬성하느냐 반대하느냐가 아닙니다. **국가는 좋은 기업을 고르지 말고, 좋은 행동이 선택받는 시장을 만들어야 하지 않는가.** 이 원칙을 기준으로 공정경쟁, 기존 산업생태계, 정책 실패의 책임, 그리고 가능한 대안을 차례로 살펴보겠습니다.",
  ],
  sections: [
    {
      title: "첫 번째 논란 — 지원을 받는 기업이 생기면 불이익을 받는 기업도 생깁니다",
      paragraphs: [
    ...
    {
      title: "두 번째 논란 — 지원이 겹치면 하나의 정책산업이 됩니다",
      paragraphs: [
    ...
    {
      title: "세 번째 논란 — 정책이 실패하면 기존 시장은 되돌아올 수 있습니까",
      paragraphs: [
    ...
    {
      title: "네 번째 논란 — 좋은 목적은 질문을 막는 면허가 아닙니다",
      paragraphs: [
    ...
    {
      title: "결론 — 사회적경제를 키우되, 국가가 소유하지 않게 해야 합니다",
      paragraphs: [
