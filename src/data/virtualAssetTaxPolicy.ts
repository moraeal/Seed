...
export const virtualAssetTaxPolicy: TaxPolicy = {
  ...
  heroImage: {
    ...
    alt: { ko: "2027년 달력 옆에서 휴대전화 거래 내역과 계산서를 대조하는 시민의 AI 이미지", en: "AI-generated image of a citizen comparing digital-asset transactions with a worksheet beside a 2027 calendar" },
    caption: { ko: "2027년 시행을 앞두고 거래 내역과 취득가액, 비용을 확인하는 모습. AI 이미지", en: "Checking transaction records, acquisition costs and expenses before the scheduled 2027 start. AI-generated image." },
  },
  processNote: {
