...
export const northKoreanPowsTranslation: BriefingTranslation = {
  ...
  title: "Two North Korean POWs have reached South Korea. What happened to their right to choose?",
  subtitle: "Reading the UN announcement, Seoul's response, and twenty months of reporting",
  ...
  keyHighlights: [
    ...
    "Their wishes and the risk of forced return must be examined alongside North Korea's deployment and its possible security consequences.",
  ],
  content: [
  ...
  sourceLabels: [
    ...
    "DW · North Korean POWs stuck in Ukraine as Seoul hesitates (Feb. 18, 2026)",
