...
export const fukushimaJourneyColumn: SeedColumn = {
  ...
  readMinutes: 24,
  summary: "따라서 원자력 발전에 대한 생각이 우호적으로 바뀐 이후에도 원전사고가 발생한 지역의 실제 모습을 직접 보고, 사람들에게 제대로 된 정보를 전달할 필요성을 느꼈다. 그러던 차에 사실과 과학 네트웤의 두 분 대표님으로부터 후쿠시마현 공동 방문제의가 들어와 2019년 5월 27일~29일, 2박 3일간의 일정으로 후쿠시마현을 다녀오게 되었다.",
  displayHero: false,
  displayInlineImage: false,
  heroImage: {
    src: `${imageRoot}/bin0007.webp`,
    alt: "후쿠시마시 현지 숙소 앞에 선 사실과 과학 네트웤 방문단",
    caption: "그림 1. 후쿠시마시 현지 숙소 앞에서 사과넷 대표님들과 필자",
    credit: "원문 수록 사진",
    sourceUrl: "",
  },
  inlineImage: {
